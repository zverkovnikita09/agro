      ...
      <div className={styles.row}>
        ...
        <div className={styles.loadInfo}>
          <div className={styles.loadInfo__item}>
            <Text as={"p"} size={TextSize.L} weight={TextWeight.MEDIUM}>Перевезено:</Text>
            <Text as={"p"} size={TextSize.M} weight={TextWeight.MEDIUM}>1385 т <span className={styles.loadLimit}>/ 2000 т</span></Text>
          </div>
          <div className={styles.loadInfo__item}>
            <Text as={"p"} size={TextSize.L} weight={TextWeight.MEDIUM}>Норма:</Text>
            <Text as={"p"} size={TextSize.M} weight={TextWeight.MEDIUM}>500 т <span className={styles.loadLimit}>/ день</span></Text>
          </div>
          <div className={styles.loadInfo__item}>
          ...
          <div className={styles.radialInfo}>
            <svg viewBox='0 0 42 42'>
              ...
              <circle cx='21' cy='21' r='15.9154' fill='transparent' strokeWidth='4px' stroke='var(--disabled-color)'></circle>
              <circle cx='21' cy='21' r='15.9154' fill='transparent' strokeWidth='5px' stroke='var(--primary-yellow)' strokeDasharray='70 30' strokeLinecap='round'></circle>
            </svg>
